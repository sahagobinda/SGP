...
class PPO_EWC():
    ...
    def renew_optimizer(self):
        # self.optimizer = optim.AdamW(self.actor_critic.parameters(), lr=self.lr)#, eps=self.eps)
        # self.optimizer = optim.SGD(self.actor_critic.parameters(), lr=self.lr, momentum=0.9)
