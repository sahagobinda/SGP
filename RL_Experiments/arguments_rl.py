...
def get_args():
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.97,
        help='threshold for GPM')
    parser.add_argument(
        '--threshold_inc',
        type=float,
        default=0.005,
        help='threshold increment for GPM')
    parser.add_argument(
        '--custom_adam',
        action='store_true',
        default=False,
        help='use custom adam optimizer in GPM')
    parser.add_argument(
        '--network_bias',
        action='store_true',
        default=False,
        help='use bias units in the network')
    parser.add_argument(
        '--gpm-mini-batch',
        type=int,
        default=32,
        help='no of mini batch for GPM computation')
    parser.add_argument(
        '--scale_coff',
        type=int,
        default=5,
        help='scale coefficient for SGP')
    parser.add_argument(
        '--save-name',
        default=None,
